...
(function (PostsApp) {
    ...
    function createBlogPost(id, imageUrl, titleStr, paragraphStr, page) {
        const classPrefix = page === Page["posts-page"] ? "posts-page" : "full-post-page";
    ...
    function loadPostsPage() {
        ...
        for (let i = 0; i < PostsApp.posts.length; i++) {
            const post = PostsApp.posts[i];
    ...
    function getCommentsByPostId(postId) {
        return PostsApp.comments.filter(comment => comment.getPostId() == postId);
    }
